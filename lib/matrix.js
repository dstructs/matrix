...
*
* @param {Number...} i - subscripts
* @returns {Number} matrix element
*/
Matrix.prototype.get = function( i0, i1 ) {
	// var idx = 0,
		// i;
	...
	return this.data[ i0*this._strides[0] + i1*this._strides[1] ];
}; // end METHOD get()

/**
* METHOD: set( i, j, k,..., value )
...
* @returns {Number} matrix element
*/
Matrix.prototype.set = function( i0, i1, v ) {
	// var idx = 0,
	// 	i;
	...
	// 	idx += this._strides[ i ] * arguments[ i ];
	// }
	// return this.data[ idx ] = arguments[ i ];
	return this.data[ i0*this._strides[0] + i1*this._strides[1] ] = v;
}; // end METHOD get()
